...
def addPredictions(input_data):
    ...
    st.write("Probability of beig benign: ", model.predict_proba(input_array_scaled)[0][0])
    st.write("Probability of beig malicious: ", model.predict_proba(input_array_scaled)[0][1])

    st.write("This app is intended to assist profesionals, please do not use it to self diagnose.")
...
def main():
    ...
    with st.container():
        ...
        st.write("This is an app that uses machine learning to predict whether breast mass is benign or malignant")

    col1, col2 = st.columns([4, 1])

    with col1:
        radar_chart = getRadarChart(input_data)
